...
static ImU32 OrganismColor(const std::string& name, float energy, float maxE) {//��Ҫ��չ
    float i = (maxE > 0.001f) ? energy / maxE : 0.5f;
    i = std::clamp(i, 0.25f, 1.0f);
    ...
    return IM_COL32((int)(128*i), (int)(128*i), (int)(128*i), 210);//Ĭ�ϵ�
}
